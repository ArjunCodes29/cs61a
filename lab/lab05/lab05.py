...
def replace_loki_at_leaf(t, lokis_replacement):
    ...
    def helper(copy):
        if is_leaf(copy) and label(copy)== 'loki':
            return tree(lokis_replacement)
        else:
            return tree(label(copy),[helper(b) for b in branches(copy)])
    return helper(tree(label(t),branches(t)))
...
def closer_city(lat, lon, city_a, city_b):
    ...
    'Bucharest'
    """
    location= make_city("point",lat,lon)
